...
try {
    ...
    require_once __DIR__ . '/../../../helpers/whitebox/whitebox_lab12_defaults.php';
    require_once __DIR__ . '/../../../helpers/whitebox/whitebox_lab18_defaults.php';
    require_once __DIR__ . '/../../../helpers/whitebox/whitebox_lab19_defaults.php';
    ...
    require_once __DIR__ . '/../../../helpers/whitebox/whitebox_academy_sqli_verify.php';
    require_once __DIR__ . '/../../../helpers/whitebox/whitebox_lab18_access_verify.php';
    require_once __DIR__ . '/../../../helpers/whitebox/whitebox_lab19_idor_verify.php';
    require_once __DIR__ . '/../../../helpers/whitebox/whitebox_xss_verify.php';
    require_once __DIR__ . '/../../../helpers/utils/lab_completion_helper.php';
    require_once __DIR__ . '/../../../helpers/utils/lab_production_state.php';
    require_once __DIR__ . '/../../../helpers/utils/lab_access_token_bind.php';
} catch (Throwable $e) {
