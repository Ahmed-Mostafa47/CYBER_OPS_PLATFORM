...
try {
    ...
    require_once __DIR__ . '/../../../helpers/utils/labs_proposal_schema.php';
    require_once __DIR__ . '/../../../helpers/utils/lab_publish_helper.php';
...
$sid = $submissionId;
$sel = $conn->query("
  SELECT submission_id, submitted_by_user_id, title, description, labtype_id, difficulty, points_total, owasp_category, status, solution, hints
...
$hintsRaw = trim((string) ($row['hints'] ?? ''));
