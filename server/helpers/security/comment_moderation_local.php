...
function hackme_local_moderation_blocklist(): array
{
    ...
    // Broad Egyptian/Arabic insults list (explicit and common slang)
    $ar = [
        'كسم', 'كسمك', 'كسك', 'كس ام', 'كس أم', 'كسامك', 'كسختك', 'كس امك', 'كس أمك', 'كسمين',
        'خول', 'عرص', 'منيك', 'منيوك', 'قحبة', 'قحاب', 'شرموطة', 'شرموط', 'شراميط',
        'زبي', 'زبك', 'طيزك', 'عاهرة', 'يلعن', 'ابن الكلب', 'الكلب', 'يا كلب',
        'ابن الزنا', 'حرامي', 'يخربيت', 'تفو', 'اللعنة', 'خرا', 'زفت', 'وسخة', 'وسخ',
        'يلعنك', 'لعنك', 'ياعرص', 'ياخول', 'يا خول', 'يا عرص', 'كس اختك', 'كس اهلك',
        'لبوة', 'متناكة', 'تناكة', 'متناك', 'نتن', 'يا نتن', 'يا وسخ', 'يا زبالة',
        'يا قذر', 'يا واطي', 'يا حقير', 'تيزك', 'بزاز', 'بزازك', 'فخذك', 'فخادك',
        'ايري', 'ايرك', 'سكس', 'نيك', 'نيكة', 'بتاعي', 'بتوعي', 'متاعي',
    ];
