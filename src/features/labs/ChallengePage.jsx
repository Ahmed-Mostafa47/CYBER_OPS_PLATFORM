      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6 mb-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-400 font-mono mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-gray-800/80 backdrop-blur-lg rounded-2xl p-5 sm:p-6 border border-gray-700">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-800/80 backdrop-blur-lg rounded-2xl p-5 sm:p-6 border border-gray-700 lg:sticky lg:top-24">
              <h2 className="text-xl font-bold text-white mb-4 font-mono flex items-center gap-2">
