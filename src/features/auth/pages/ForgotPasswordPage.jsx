...
<<<<<<< HEAD:src/components/auth/ForgotPasswordPage.jsx
import BinaryRain from "../ui/BinaryRain";
=======
import BinaryRain from "@/features/shared/ui/BinaryRain";
>>>>>>> Ahmeds_branch:src/features/auth/pages/ForgotPasswordPage.jsx
...
const ForgotPasswordPage = ({ onBackToLogin, onResetSent }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost/graduatoin_project/server/auth/forgot_password.php', {
        method: 'POST',
        headers: {
